...
- CSV upload plus generated CSV and chart downloads.
...
| Persistence | Active work stays in memory only; uploads, notebooks, and recent work are not restored after the process terminates | Validate foreground/background continuity and fresh-canvas relaunch behavior |
