...
- `test_tutorial_browser.py --engine chromium|webkit`: original zoomed follow-along tour, responsive captures, chapter navigation and replay.
- `test_public_learning.mjs`: built HTML links/assets, canonical URLs, sitemap coverage and removed-library exclusion.
