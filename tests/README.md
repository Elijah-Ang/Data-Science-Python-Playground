...
- `test_tutorial_browser.py --engine chromium|webkit`: script-free visual tour, section links, lesson diagrams/tables, mobile overflow and desktop-only tour-button sizing.
- `test_public_learning.mjs`: all built HTML asset/link targets, public curriculum pages, canonical URLs and sitemap coverage.
