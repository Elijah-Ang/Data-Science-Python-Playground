...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        # The legacy Guided/Practice toggle was removed from the shared
        # notebook surface. Keep the browser assertion aligned with the
        # single direct-run experience now presented to learners.
        if page.locator("#guidedModeButton").count() or page.locator("#practiceModeButton").count():
            raise AssertionError("Legacy Guided/Practice controls should not be exposed.")
    ...
    print(
        ...
        "neural-network classification/regression, scaffold validation, "
