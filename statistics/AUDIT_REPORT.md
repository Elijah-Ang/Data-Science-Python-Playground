...
- **63 native tests passed**, retaining all original numerical oracles and adding independent goodness-of-fit, interval, graph-axis, schema, boundary and CSS-base checks.
...
- **Data / Statistics / ML computed styles:** 18 representative components, both themes, widths **320, 390, 834, 1120, 1121 and 1512**. The notebook method suite additionally covers 980px. Controls, typography, source, Inspector, editor, cell/output headers, tables, console and toolbar match. Route state colors intentionally reflect each page’s different progress.
